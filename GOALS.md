...
- [ ] Factor distance computation into a pure helper and unit test it.
...
- [ ] Add unit tests for `path_search.py` on tiny inputs (2-8 points).
- [ ] Add unit tests for `vector.py` operations and edge cases (zero normalization, div by zero).
- [ ] Add a smoke test that imports modules without side effects.
